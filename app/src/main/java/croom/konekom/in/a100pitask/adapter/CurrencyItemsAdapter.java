...
public class CurrencyItemsAdapter extends RecyclerView.Adapter<CurrencyItemsAdapter.ViewHolder> {
    ...
    public CurrencyItemsAdapter(Context context, List<Currency> currencies) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View contactView = inflater.inflate(R.layout.currency_item, viewGroup, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView currencyLong;
        public TextView txFee;
